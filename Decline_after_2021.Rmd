...
lines_selected <- ggplot(df_plot_lite, aes(x=Year, y=Norm_Articles, color=Country))+
  ...
  annotate("rect", xmin=target_time_plot[2]+0.1, xmax=target_time_plot[2]+5.5, ymin=-1, ymax=160, fill="#f6f8fa")+
  
  # Inset selected countries
  annotate("rect", xmin=target_time_plot[2]+0.1, xmax=target_time_plot[2]+5.5, ymin=47, ymax=150, color="lightgrey", linewidth=0.5,  fill="#e8eaed", alpha=0.6)+
  ...
  scale_x_continuous(limits = c(target_time_plot[1]-0.2,target_time_plot[2]+5.6), breaks = seq(target_time_plot[1], target_time_plot[2], by=2), expand = c(0,0))+
  ...
  labs(title = "Evolution of the number of cancer studies, normalized to 2021")+
